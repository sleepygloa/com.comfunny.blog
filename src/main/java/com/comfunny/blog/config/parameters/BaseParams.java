package com.comfunny.blog.config.parameters;
...
import com.comfunny.blog.config.contraints.CoreConstants;
...
public abstract class BaseParams extends HashMap<String,Object> implements Params {
	...
	public void init(){
		this.setParam("stsCd", 100);
		this.setParam("errCd", "");
		this.setParam("msgCd", 0);
		this.setParam("msgTxt", "");
		this.setParam("rtnUri", "");
	...
	public void setTotalCount(int totalRowCnt){
		...
		this.setParam(CoreConstants.END_PAGE,endPage);
		this.setParam(CoreConstants.TOTAL_ROW_CNT, totalRowCnt);
	}
	public int getTotalCount(){
		return getIntParam(CoreConstants.TOTAL_ROW_CNT);
	}
	@Override
	...
	public void setDataTable(DataTable value) {
		this.setParam(CoreConstants.DATA_TABLE, value);
	}
	@Override
	...
	public DataTable getDataTable() {
		return (DataTable) getParam(CoreConstants.DATA_TABLE);
	}
	@Override
	public void setStsCd(int value) {
		this.setParam(CoreConstants.STS_CD, value);
	}
	@Override
	public String getStsCd() {
		return String.valueOf(getParam(CoreConstants.STS_CD));
	}
	@Override
	...
	public void setMsgCd(String errCd) {
		this.setParam(CoreConstants.MSG_CD, errCd);
//		this.setParam(CoreConstants.MSG_TXT, NoticeMessageUtil.getMessage(errCd));
	}
	@Override
	public void setMsgCd(String errCd, Object[] msgValues) {
		this.setParam(CoreConstants.ERR_CD, 0);
		this.setParam(CoreConstants.MSG_CD, errCd);
//		this.setParam(CoreConstants.MSG_TXT, NoticeMessageUtil.getMessage(errCd,msgValues, this.locale));
	}
...
//	       }
//	       this.setParam(CoreConstants.MSG_TXT, MSG_TXT);
	}
...
//	불필요
	...
	public void setMsgLangCd(String lang, String errCd, Object[] args) {
		this.setParam(CoreConstants.MSG_CD, errCd);
//		this.setParam(CoreConstants.MSG_TXT, NoticeMessageUtil.getMessage(errCd, args));
	}
...
//       		this.setParam(CoreConstants.MSG_TXT, MSG_TXT);
	...
	public String getMsgCd() {
		return String.valueOf(getParam(CoreConstants.MSG_CD));
	}
	@Override
	public void setMsgTxt(String value) {
		this.setParam(CoreConstants.MSG_TXT, value);
	}
	@Override
	public String getMsgTxt() {
		return String.valueOf(getParam(CoreConstants.MSG_TXT));
	}
	@Override
	public void setRtnUri(String value) {
		this.setParam(CoreConstants.RTN_URI, value);
	}
	@Override
	public String getRtnUri() {
		return String.valueOf(getParam(CoreConstants.RTN_URI));
	}
