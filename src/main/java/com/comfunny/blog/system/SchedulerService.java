...
//import vertexid.paragon.comm.job.ReceiveAgingAutoJob;
//
//
//
//
...
//        LOG.debug("SchedulerService exeScheduler : " + inParams);
//        Params outParams = ParamsFactory.createParams(inParams);
//        vertexid.paragon.comm.job.ParagonReloadJob testJob = new vertexid.paragon.comm.job.ParagonReloadJob();
//
//        ReceiveAgingAutoJob agingAuto = new ReceiveAgingAutoJob();
//
//        agingAuto.executeInternal(null);
//
//        LOG.debug("=========jobexe======");
////        int cnt = 0;
////        for(DataRow dr: inParams.getDataTable("dt_scheduler")){
