...
public class AllowedURIController {
	...
	public Params listAllowedURI(Params inParams) {
		LOG.debug("AllowedURIController listAllowedURI");
     ...
     * @Date 2018. 2. 06.
     */
    @RequestMapping("/deleteAllowedURI")
    public Params deleteAllowedURI(Params inParams){
        return allowUrlService.deleteAllowedURI(inParams);
    }
}
